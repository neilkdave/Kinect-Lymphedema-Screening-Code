...
:: RGB image
set RGB_PATH=C:\Users\censsis\Documents\Kinect Code to Run\RunKinectImage.LEO\RunKinectImage\bin\Release
set RGB_EXE=RunKinectImage.exe

:: depth image
set DEPTH_PATH=C:\Users\censsis\Documents\Kinect Code to Run\RunKinect.LEO\RunKinect\bin\Release
...
:begin
	...
	set DEPTH_FILENAME=%SUB_PATH%\%IDX_FORMATTED%.dep
